...
def get_portfolio_list() -> str:
    ...
    for portfolio_id in portfolios:
        http_functions += f'<form action=/get_portfolio_by_id/{portfolio_id}><input type="submit" style="align: center" value={portfolio_id} class="btn btn-primary btn-large btn-block" style="display: inline-block;"></form>'
